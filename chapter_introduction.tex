...
In \Cref{chapter_gradient_flows_and_mcf} we give a soft mathematical 
...
Afterwards in \Cref{chapter_ac_equation}, we consider the Allen--Cahn 
equation 
...
Continuing with \Cref{chapter_convergence_to_evolving_partition}, we take a 
...
\cite{convergence_of_allen_cahn_equation_to_multiphase_mean_curvature_flow}. 
We show that the in \Cref{chapter_convergence_to_evolving_partition} 
...
Lastly in \Cref{chapter_de_giorgis_mcf} we present new results 
...
In the final 
\Cref{subsection_de_giorgi_type_varifold_solutions_for_mcf}, we discuss the 
