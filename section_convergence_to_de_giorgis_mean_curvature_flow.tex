...
\begin{definition}[De Giorgi type varifold solution for twophase mean 
curvature flow]
...
the case of arbitrary surface tensions and removes the varifold $ \mu^{ i i } $.
...
curvature flow]
	...
	Given initial data 
	$ (
		( \omega_{ 0 }^{ i j } )_{ 1 \leq i , j \leq P, i \neq j },
	...
	with initial data} $ ( \omega_{ 0 } , \chi_{ 0 } ) $ \emph{and surface 
...
Equations (\ref{equation_varifold_velocity_multiphase}) and 
...
\Cref{figure_interfaces_collapse}, which follows from equation 
